...
#define SETTING_AREA_HEIGHT COORDINATE_MIDDLE_TOP_LEFT_Y - (BIGGEST_RECTANGLE_COORDINATE_Y)
...
/*this is score list words(right\wrong word included) print coordinates*/
#define COORDINATE_SCORE_LIST_RIGHT_X COORDINATE_MIDDLE_TOP_LEFT_X + OUTERMOST_BORDER_WIDTH + 1
#define COORDINATE_SCORE_LIST_RIGHT_Y COORDINATE_MIDDLE_TOP_LEFT_Y

#define COORDINATE_SCORE_LIST_WRONG_X COORDINATE_MIDDLE_TOP_LEFT_X + OUTERMOST_BORDER_WIDTH + SCORELIST_WIDTH / 2
#define COORDINATE_SCORE_LIST_WRONG_Y COORDINATE_MIDDLE_TOP_LEFT_Y

#define SETTING_BOTTOM_MARGIN (GAMELIST_HEIGHT - (SETTING_AREA_HEIGHT)-1)
